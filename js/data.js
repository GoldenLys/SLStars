...
var Technologies = {
    ...
    1: { name: "Rusty drone II", cost: 1000, gain: 0.15, type: 0, need: 0, req: [3, 10], req2: [0, 10] },
    2: { name: "Basic drone I", cost: 5000, gain: 0.25, type: 0, need: 1, req: [3, 20], req2: [4, 20] },
    3: { name: "Basic drone II", cost: 50000, gain: 0.5, type: 0, need: 2, req: [10, 30], req2: [6, 30] },
    4: { name: "Basic drone III", cost: 500000, gain: 0.75, type: 0, need: 3, req: [10, 50], req2: [7, 50] },
    5: { name: "Advanced drone I", cost: 5000000, gain: 1, type: 0, need: 4, req: [10, 100], req2: [12, 100] },
    6: { name: "Advanced drone II", cost: 100000000, gain: 1.25, type: 0, need: 5, req: [10, 200], req2: [12, 200] },
    7: { name: "Advanced drone III", cost: 10000000000, gain: 1.5, type: 0, need: 6, req: [16, 150], req2: [11, 250] },
    8: { name: "Alien drone I", cost: 50000000000, gain: 2, type: 0, need: 7, req: [16, 200], req2: [17, 250] },
    9: { name: "Alien drone II", cost: 100000000000, gain: 2.5, type: 0, need: 8, req: [16, 500], req2: [17, 500] },
};
...
var tutorials = {
    ...
    4: { title: "Galaxy", text: "<h4>The prestige system of the game</h4><br>The galaxy will give you more inventory places.<br>But it will also increase the <i class='red sort amount up icon'></i> EP needed to change your location."},
    5: { title: "Game menu", text: "There is also a menu where you can export/import or reset your savegame or re-open this guide.<br>Just click on Menu on the upper left corner of the screen.", },
};
